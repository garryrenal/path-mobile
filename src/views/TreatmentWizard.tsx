        ...
        return (
            <div className="space-y-8 pb-24">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    ...
                    <Field label="Temp (°F)" type="number" value={formData.temp} onChange={(v: any) => onChange('temp', v)} />
                ...
                <div className="space-y-4">
                     <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Assessment Detail</h4>
                     <Field label="LOC" value={formData.loc} onChange={(v: any) => onChange('loc', v)} />
                     <Field label="Cardiac Rhythm" value={formData.rhythm} onChange={(v: any) => onChange('rhythm', v)} />
                     <Field label="Breath Sounds" value={formData.breath} onChange={(v: any) => onChange('breath', v)} />
                </div>
            </div>
        );
    }
